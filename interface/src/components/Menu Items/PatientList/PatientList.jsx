...
const PatientList = () => {
    ...
    const [patients, setpatients] = useState([
        { name: "Леонов А.Д.", direction: "Терапия", phone: "+79222557017", mail: "example@gmail.com", snils: "133446789905657" },
        { name: "Денисов П.Ф.", direction: "Хирургия", phone: "+79182557010", mail: "example@gmail.com", snils: "133446789905657" },
        { name: "Аминов М.А.", direction: "Кардиология", phone: "+79122557013", mail: "example@gmail.com", snils: "133446789905657" },
        { name: "Терябина Е.В.", direction: "Терапия", phone: "+79922557028", mail: "example@gmail.com", snils: "133446789905657" },
        { name: "Вассеников В.В.", direction: "Терапия", phone: "+79112557010", mail: "example@gmail.com", snils: "133446789905657" },
        { name: "Рагимов Р.М.", direction: "Кардиология", phone: "+79892557092", mail: "example@gmail.com", snils: "133446789905657" },
        { name: "Михайлов Ф.К.", direction: "Неврология", phone: "+79282557031", mail: "example@gmail.com", snils: "133446789905657" },
        { name: "Евгененко Т.Б.", direction: "Дерматология", phone: "+79722557092", mail: "example@gmail.com", snils: "133446789905657" },
        { name: "Мастеренко П.Ф.", direction: "Стоматология", phone: "+79822557018", mail: "example@gmail.com", snils: "133446789905657" },
    ])
    ...
    return (
        <div className='worker-list'>
            ...
            <p className='workerlist-head'>ВСЕ ПАЦИЕНТЫ  ({patients.length})</p>
                ...
                {patients.map((patient, i) => {
                    return <table className='doctors'>
                        <tr className="worker-doc" key={i}>
                            <td className='worker-name'>{patient.name}</td>
                            <td>{patient.direction}</td>
                            <td>{patient.phone}</td>
                            <td>{patient.mail}</td>
                            <td>{patient.snils}</td>
                            <div className='worker-divs'>
                                <div className='appeal'><p>Срочный</p></div>
