    ...
    return (
        <div className='calculation'>
            ...
            <div className='calc-main'>
                <input type="text" placeholder='ФИО сотрудника или ID' />
                <div>
                    <div className='calc-info'>
                        <p>Должность: терапевт, хирург</p>
                        <p>Отработано часов по графику: 180</p>
                        <p>Отработано часов сверхурочно: 20</p>
                        <p>Итого: 60 000₽</p>
                    </div>
                    <div className='calc-info two' >
            ...
            <div className='calc-btns'>
                <button>Скачать отчет за всех сотрудников за месяц</button>
                <button>Заплатить всем сотрудникам</button>
            </div>
        </div>
    )
}
